"""Detection aggregates and reporting models for Mojo."""
...
@dataclass
class Detection:
    """Individual pattern detection or hazard signal in Mojo."""

    pattern_type: PatternType
    pattern_category: PatternCategory
    target_name: str
    target_kind: str  # "struct", "trait", "fn", "alias", "kernel"
    ...
    def summary(self) -> str:
        ...
        return f"Mojo architectural pattern: {self.pattern_type.value}"
...
class DetectionReport:
    """Aggregate scan result containing all detections across a Mojo project."""
