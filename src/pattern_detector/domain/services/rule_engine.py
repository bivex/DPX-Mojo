"""Domain service evaluating pattern detection rules on Mojo CodeModel."""
...
class RuleEngineService:
    """Evaluates rules against a Mojo CodeModel with confidence thresholding and filtering."""
