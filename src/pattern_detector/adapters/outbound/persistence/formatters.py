"""JSON, Markdown, SARIF formatters & persistence repositories for Mojo."""
...
class MarkdownReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        lines = [
            f"# 🔥 DPX-Mojo: Architectural Context & Pattern Report",
            f"",
            ...
            "runs": [
                {
                    "tool": {
                        "driver": {
                            "name": "DPX-Mojo",
                            "informationUri": "https://github.com/bivex/DPX-Mojo",
                            "version": "0.1.0",
                        }
                    },
                    "results": results,
