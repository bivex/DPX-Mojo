"""Console Rich Formatter for Mojo pattern detection findings."""
...
class ConsoleReportFormatter(ReportFormatterPort):
    ...
    def format(self, report: DetectionReport, verbose: bool = False) -> str:
        ...
        # Header Banner
        header = Panel.fit(
            f"[bold white]🔥 DPX-Mojo: SIMD Vectorization, Ownership, Memory Safety & AI Hardware Acceleration (Mojo 24.x - 25.x+)[/bold white]\n"
        ...
        console.print(table)
        console.print("\n[bold]📋 Identified Architectural Patterns & Hardware Signals:[/bold]\n")
